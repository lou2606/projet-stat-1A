...
def donne_url_id():
    ...
    for ell in tab_nom_id_dep :
        url = 'https://www.interieur.gouv.fr/Elections/Les-resultats/Presidentielles/elecresult__presidentielle-2017/(path)/presidentielle-2017/093/' + ell[2].rjust(3, '0') + '/' + ( ell[1].rjust(3, '0')).rjust(6, '0') +'.html'
...
with open('reselections2017communes.csv', 'w', newline='') as file:
